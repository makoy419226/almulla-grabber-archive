    ...
    <SiteLayout>
      ...
      <section className="relative overflow-hidden bg-primary text-primary-foreground">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-32 pt-28 text-center sm:px-6 lg:px-8 lg:pb-44 lg:pt-36">
          ...
          <p className="copy-center motion-slide-bottom motion-delay-3 mt-8 max-w-2xl text-lg text-primary-foreground/80 leading-relaxed">
          ...
          <div className="data-center motion-slide-bottom motion-delay-4 mx-auto mt-14 grid max-w-2xl grid-cols-3 gap-6 border-t border-primary-foreground/20 pt-8">
            {stats.map((s) => (
              <div key={s.label}>
      ...
      <section className="bg-background">
        <div className="relative z-10 mx-auto -mt-20 max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="motion-slide-bottom grid gap-8 lg:grid-cols-12">
            ...
            <aside className="data-center flex flex-col justify-between rounded-lg bg-primary p-8 text-primary-foreground lg:col-span-5 lg:p-12">
              <div>
      ...
      <section className="bg-background py-24 lg:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-14 flex flex-wrap items-end justify-center gap-6 text-center">
            ...
            <div className="mx-auto max-w-sm text-[15px] text-muted-foreground">
          ...
          <div className="grid overflow-hidden rounded-lg border border-border bg-border sm:grid-cols-2 lg:grid-cols-4">
            {pillars.map((p) => {
              ...
              return (
                ...
                >
                  <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center rounded-md bg-primary/5 text-primary transition-colors group-hover:bg-primary group-hover:text-primary-foreground">
